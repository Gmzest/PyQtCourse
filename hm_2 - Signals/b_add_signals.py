...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentTextChanged.connect(self.onChangeComboBox)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        self.spinBox.textChanged.connect(self.onChangeSpinBox)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
        self.dateTimeEdit.dateTimeChanged.connect(self.onChangeDateTimeEdit)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def onChangeComboBox(self) -> None:

        self.plainTextEditLog.setPlainText(self.comboBox.currentText())

    def onChangeSpinBox(self) -> None:

        self.plainTextEditLog.setPlainText(self.spinBox.text())

    def onChangeDateTimeEdit(self) -> None:
